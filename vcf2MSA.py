...
VERSION_INFO = \
    ...
    Version-01:
        2020-01  Convert vcf format to multiple sequence alignment
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument("-r", "--Reference", required=True,
                        help="Input reference fasta file, index file generated by samtools is required")
    ...
    parser.add_argument("-f", "--format",
                        help="Format of genotypes in vcf file",
